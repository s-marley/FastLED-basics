...
void setup() {
  ...
  ControlFont fontCode = new ControlFont(pfont,30);
  ...
  gui.addSlider("octaveSliderValue")
    .setPosition(950,300)
    .setSize(220, 30)
    .setRange(1,4)
    .setId(3)
...
void controlEvent(ControlEvent theEvent) {
  ...
  Output = "<" + xSliderValue + "," + scaleSliderValue  + "," + octaveSliderValue  + "," + timeSliderValue + ">";
...
void updateText() {
  String s = "fill_raw_noise8(noiseData, 56, " + octaveSliderValue + ", " + xSliderValue + ", " + scaleSliderValue + ", " + timeSliderValue + ");";
  txt.setText(s);
}
